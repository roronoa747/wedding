...
const translations = {
  kz: {
    ...
    'detail-venue-val':      'Мейрамхана атауы<br />Мекенжай',
    'detail-dress-title':    'Киім үлгісі',
    'detail-dress-val':      'Салтанатты<br />Жұмсақ реңктер',
  ...
  ru: {
    ...
    'detail-venue-val':      'Название банкетного зала<br />Адрес проведения',
    'detail-dress-title':    'Дресс-код',
    'detail-dress-val':      'Торжественный<br />Нежные тона',
  ...
  en: {
    ...
    'detail-venue-val':      'Venue Name<br />Venue Address',
    'detail-dress-title':    'Dress Code',
    'detail-dress-val':      'Formal Attire<br />Soft Tones',
